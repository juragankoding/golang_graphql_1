...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.insertBarang":
		if e.complexity.Query.InsertBarang == nil {
			break
		}
...
func (ec *executionContext) _Query_insertBarang(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Query_getInfoKaryawan(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOKaryawan2ᚖexample_crud_graphqlᚋgraphᚋmodelᚐKaryawan(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOKaryawan2ᚖexample_crud_graphqlᚋgraphᚋmodelᚐKaryawan(ctx context.Context, sel ast.SelectionSet, v *model.Karyawan) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
